        ...
        <div id="main" className="p-10">
          <section id="contact-section">
            ...
            <div className="p-10" style={{ padding: '15px' }}>
              ...
              <p>
                Join the newsletter for captivating illustrations, fascinating
                insights, and exclusive content. Explore archaeological sites
                and periods from all around the world and thereby ignite your
                imagination through illustrations, doodles and history.
                <br />
                Get ready for a visual journey through time with archaeoINK.
              </p>
            </div>
            <div
